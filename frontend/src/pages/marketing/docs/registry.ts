...
// This registry lives at frontend/src/pages/marketing/docs/, so the repo docs
// tree is five levels up (docs → marketing → pages → src → frontend → repo).
...
// Legal docs live inside the marketing pages so they ship with the site even
// when the repo docs tree is absent. They sit at ../content/ relative here.
